...
class TestDexml(unittest.TestCase):
    def test_base(self):
        ...
        self.assertEquals(h.render(pretty=True),
                          '<?xml version="1.0" ?>\n<hello/>\n')
        self.assertEquals(h.render(fragment=True, pretty=True), "<hello/>\n")
        self.assertEquals(h.render(encoding="utf8"),
                          b('<?xml version="1.0" encoding="utf8" ?><hello />'))
        self.assertEquals(h.render(encoding="utf8", pretty=True), b(
            '<?xml version="1.0" encoding="utf8" ?>\n<hello/>\n'))
        self.assertEquals(h.render(encoding="utf8", fragment=True),
                          b("<hello />"))
        self.assertEquals(h.render(encoding="utf8", fragment=True, pretty=True),
                          b("<hello/>\n"))

        self.assertEquals(h.render(), "".join(h.irender()))
        self.assertEquals(h.render(fragment=True),
                          "".join(h.irender(fragment=True)))
        self.assertEquals(h.render(encoding="utf8"),
                          b("").join(h.irender(encoding="utf8")))
        self.assertEquals(h.render(encoding="utf8", fragment=True),
    ...
    def test_unicode_model_tagname(self):
        ...
        h = hello.parse(
            u"<hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>")
        self.assertTrue(h)

        h = hello.parse(
            u"<?xml version='1.0' encoding='utf-8' ?><hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>")
        h = hello.parse(
            u"<?xml version='1.0' encoding='utf-16' ?><hel\N{GREEK SMALL LETTER LAMDA}o>world</hel\N{GREEK SMALL LETTER LAMDA}o>")
        self.assertTrue(h)

        h = hello()
        self.assertEquals(h.render(),
                          u'<?xml version="1.0" ?><hel\N{GREEK SMALL LETTER LAMDA}o />')
        self.assertEquals(h.render(fragment=True),
                          u"<hel\N{GREEK SMALL LETTER LAMDA}o />")
        self.assertEquals(h.render(encoding="utf8"),
                          u'<?xml version="1.0" encoding="utf8" ?><hel\N{GREEK SMALL LETTER LAMDA}o />'.encode(
                              "utf8"))
        self.assertEquals(h.render(encoding="utf8", fragment=True),
                          u"<hel\N{GREEK SMALL LETTER LAMDA}o />".encode(
                              "utf8"))
    ...
    def test_unicode_string_field(self):
        ...
        self.assertEquals(p.render(encoding="utf8"),
                          u'<?xml version="1.0" encoding="utf8" ?><Person name="hel\N{GREEK SMALL LETTER LAMDA}o" />'.encode(
                              "utf8"))
    ...
    def test_string_with_special_chars(self):
        ...
        l = letter.parse(
            "<letter><msg><![CDATA[hello & goodbye]]></msg></letter>")
        self.assertEquals(l.message, "hello & goodbye")

        l = letter(message="XML <tags> are fun!")
        self.assertEquals(l.render(fragment=True),
    ...
    def test_model_field(self):
        ...
        self.assertRaises(dexml.ParseError, pets.parse,
                          "<pets><person name='riley' age='2' /></pets>")
    ...
    def test_list_field(self):
        ...
        self.assertRaises(dexml.ParseError, pets.parse,
                          "<pets><pet name='riley' species='fish' /></pets>")
        self.assertRaises(dexml.ParseError, pets.parse,
                          "<pets><person name='ryan' age='26' /></pets>")
        self.assertRaises(dexml.ParseError, pets.parse,
    ...
    def test_dict_field_max_min(self):
        ...
        MyStuff.items.maxlength = 1
        self.assertEquals(len(MyStuff.parse(
            "<MyStuff><item name='hi' value='world' /></MyStuff>").items), 1)
        self.assertRaises(dexml.ParseError, MyStuff.parse,
                          "<MyStuff><item name='hi' value='world' /><item name='hello' value='earth' /></MyStuff>")
        s = MyStuff()
        s.items = [item(name="yo", value="dawg"),
                   item(name="wazzup", value="yo")]
        self.assertRaises(dexml.RenderError, s.render)
        ...
        MyStuff.items.required = True
        self.assertEquals(len(MyStuff.parse(
            "<MyStuff><item name='hi' value='world' /><item name='hello' value='earth' /></MyStuff>").items),
                          2)
        self.assertRaises(dexml.ParseError, MyStuff.parse,
    ...
    def test_choice_field(self):
        ...
        self.assertEquals(b.render(fragment=True),
                          "<breakfast><bacon num_rashers=\"1\" /></breakfast>")
    ...
    def test_choice_field_sanity_checks(self):
        ...
        self.assertRaises(ValueError, SaneChoice.parse,
                          "<SaneChoice><SaneChoice /></SaneChoice>")
    ...
    def test_XmlNode(self):
        ...
        self.assertEquals(b.contents.childNodes[0].childNodes[0].localName,
                          "world")
        self.assertEquals(b.contents.childNodes[0].childNodes[0].namespaceURI,
                          "bucket-uri")
        ...
        b2 = bucket.parse(
            "".join(fields.XmlNode.render_children(b, b.contents, {})))
    ...
    def test_namespaced_children(self):
        ...
        self.assertEquals(n2.render(fragment=True),
                          '<t:nsc xmlns:t="test:"><t:f1>7</t:f1></t:nsc>')
    ...
    def test_order_sensitive(self):
        ...
        self.assertRaises(dexml.ParseError, junk.parse,
    ...
    def test_namespace_prefix_generation(self):
        ...
        nsmap["T"] = ["T:"]
        nsmap["A"] = ["A:"]
        self.assertEquals(a1.render(fragment=True, nsmap=nsmap),
    ...
    def test_error_using_undefined_model_class(self):
        ...
        self.assertRaises(ValueError, Whoopsie.parse,
                          "<Whoopsie><UndefinedModel /></Whoopsie>")
    ...
    def test_unordered_parse_of_list_field(self):
        ...
        self.assertRaises(dexml.ParseError, Notebook.parse,
                          "<Notebook><wtf /><notes><note>one</note><note>two</note><wtf /></notes></Notebook>")
        self.assertRaises(dexml.ParseError, Notebook.parse,
...
class TestListField(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        self.assertEqual(o.render(fragment=True),
                         "<obj><f><name>N1</name></f></obj>")
    ...
    def test_list_and_model_tagnames(self):
        ...
        o.fs.append(FF(name="N1"))
        self.assertEqual(o.render(fragment=True),
                         "<obj><L><FF><name>N1</name></FF></L></obj>")
